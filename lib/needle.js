  ...
  var request = protocol.request(request_opts, function(resp) {
    ...
    if (redirect_codes.indexOf(resp.statusCode) !== -1 && self.should_follow(headers.location, config, uri)) {
      ...
      if (count <= config.follow_max) {
        ...
        if (!config.follow_keep_method && resp.statusCode != 308) {
          method    = 'GET';
          post_data = null;
    ...
    // decoding non UTF-8 bodies to UTF-8, using the iconv library.
    ...
    out.on('end', function() {
      if (callback && resp.body) { // callback mode
...
if (typeof Promise !== 'undefined') {
  module.exports = function() {
    ...
    return new Promise(function(resolve, reject) {
      module.exports.request(verb, args[0], args[1], args[2], function(err, resp, body) {
        if(typeof cb === 'function') args[3](err, resp, body)
